...
public class JLinkedInTest {
	...
	public void testGetProfile() {
		...
		jli.setFields(ProfileField.ID,ProfileField.FIRST_NAME,ProfileField.LAST_NAME, ProfileField.SUMMARY, ProfileField.PICTURE_URL,
		...
		LIProfile peep = jli.getMyProfile();
		assert peep != null;
