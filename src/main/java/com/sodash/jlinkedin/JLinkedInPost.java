...
public class JLinkedInPost extends JLinkedInAPIFacet {
	...
	public LIUpdate postComment(String companyId, String updateId, String comment) {
	 ...
	 */
	public LIUpdate postPersonShare(String comment, boolean privatePost) {
	 ...
	 */	
	public LIUpdate postCompanyShare(String comment, boolean privatePost, String companyId) {
	 ...
	 * @return
	 */
	private LIUpdate postShare(String comment, boolean privatePost, String companyId, 
			String title, String description, String url, String imgUrl) {
		Map content = null;
	 ...
	 * @return
	 */
	private LIUpdate postShare(String comment, boolean privatePost, String companyId, Map content) {
